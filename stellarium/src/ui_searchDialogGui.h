...
public:
    ...
    void setupUi(QWidget *searchDialogForm)
    {
        ...
        searchDialogForm->resize(507, 223);
        ...
        sizePolicy4.setHeightForWidth(objectTypeComboBox->sizePolicy().hasHeightForWidth());
        objectTypeComboBox->setSizePolicy(sizePolicy4);
        ...
        checkBoxLockPosition->setObjectName(QStringLiteral("checkBoxLockPosition"));
    ...
    void retranslateUi(QWidget *searchDialogForm)
    {
        ...
        stelWindowTitle->setText(QApplication::translate("searchDialogForm", "Search window", 0));
        ...
        label->setText(QApplication::translate("searchDialogForm", "Note: this tool doesn't apply the refraction correction for coordinates.", 0));
...
#ifndef QT_NO_TOOLTIP
        simbadGroupBox->setToolTip(QApplication::translate("searchDialogForm", "Use on-line astronomical database SIMBAD", 0));
#endif // QT_NO_TOOLTIP
        simbadGroupBox->setTitle(QApplication::translate("searchDialogForm", "Use SIMBAD", 0));
        ...
        checkBoxLockPosition->setText(QApplication::translate("searchDialogForm", "Lock position when coordinates are used", 0));
