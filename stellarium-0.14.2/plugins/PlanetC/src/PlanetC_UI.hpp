...
/*
   ...
   be used with the DEF_PLANETC_ macro.
 */
...
private slots:
	...
	float imageSize2scale(int pos, int screenHeight, int imgW, int imgH, bool twin);
	void setVideoSize(int);
	void setVideoVolume(int);
	void updateVideoCurTime(qint64);
	void updateVideoStatus(QMediaPlayer::MediaStatus);
