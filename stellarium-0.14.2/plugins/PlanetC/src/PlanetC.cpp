...
void PlanetC::init()
{
	...
	{
		// Create the button. Link the action
		// "actionShow_PlanetC" with the state of the
		// toolbar button.
	...
	qDebug() << " *** Using new OpenGL widgets";
#else
	qDebug() << " *** Using old QGL widgets";
#endif
}
